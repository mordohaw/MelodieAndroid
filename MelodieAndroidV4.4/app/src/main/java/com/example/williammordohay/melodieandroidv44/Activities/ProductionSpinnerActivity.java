...
public class ProductionSpinnerActivity extends AppCompatActivity {
    ...
    private Request spinnerRequest;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_production_spinner);
    ...
    public void populatelineSpinner(){
        ...
        SharedPreferences SharedParam= PreferenceManager.getDefaultSharedPreferences(ProductionSpinnerActivity.this);
        ...
        spinnerRequest = new Request(baseURL);
    ...
    public void quitCurrentActivity(View v){
        ProductionSpinnerActivity.this.finish();
    }
    ...
    public void GoToProductsView(View v){
        Intent productionIntent = new Intent(ProductionSpinnerActivity.this, ProductionActivity.class);
